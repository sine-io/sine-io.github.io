...
describe('HomePage', () => {
  it('shows the new hero while preserving featured content and browse links', () => {
    ...
    expect(
      within(projectPanel as HTMLElement).getByRole('link', { name: '查看项目' })
    ).toHaveAttribute('href', '/projects/opc')
    ...
    expect(screen.getByRole('link', { name: /OPC 专题/i })).toHaveAttribute('href', '/projects/opc')
